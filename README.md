...
A simple, in-memory command-line todo application built with Python. This application allows users to add, view, update, delete, and mark tasks as complete/incomplete.
